...
{
    public partial class Ostalo : System.Web.UI.MasterPage
    {
        ...
        public void Meni()
        {
            ...
            foreach (DataRow dr in drow)
            {
                ...
                MenuOstale.Items.Add(new MenuItem(dr["NazivMeni"].ToString(), dr["IdMeni"].ToString(), "", dr["PutanjaMeni"].ToString()));
